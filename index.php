...
<head>
    ...
    <link href="assets/vendor/datatables/Responsive-2.5.0/css/responsive.bootstrap5.min.css" rel="stylesheet">
    <link href="assets/vendor/datatables/Buttons-2.4.2/css/buttons.dataTables.min.css" rel="stylesheet">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="pt-4 pb-2">
                                        <h5 class="card-title text-center pb-0 fs-4">Ingrese a su
                                            cuenta</h5>
                                        <p class="text-center small">Por favor, ingrese usuario y
                                            contraseña</p>
                                    </div>
                                    <div class="col-12">
                                        <?php
                                    ...
                                    <form method="post" class="row g-3 needs-validation" novalidate>
                                        ...
                                        <div class="col-12">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="rememberMe">Acuérdate
                                                    de mí Acceso
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            ...
                                            <button class="botones w-100" type="submit">Login</button>
                                        </div>
                                        <div class="col-12">
                                            <!-- <p class="small mb-0">¿No tienes una cuenta? <a
                                      href="pages-register.html">Crea una cuenta</a></p>--->
                                        </div>
                                    </form>
