             ...
             <div class="modal-body">
                 <form id="form_mantenimiento" method="post">
                     <div class="row mb-3">
                         ...
                         <input hidden type="text" id="id_author" name="id_author" class="form-control">
                         ...
                         <div class="row mb-3">
                             <label for="inputText" class="col-sm-3 col-form-label">Nacionalidad</label>
                             <div class="col-sm-9">
                         ...
                         <div class="row mb-3">
                             <label for="inputDate" class="col-sm-2 col-form-label">Fech. Nacimiento</label>
                             <div class="col-sm-10">
