<?php 
    ...
    // Recoger los valores de id_prestamo y id_estudiante de la URL 
    $id_prestamo = isset($_GET['id']) ? $_GET['id'] : null;
    $id_estudiante = isset($_GET['id_student']) ? $_GET['id_student'] : null; 
...
<body>
  ...
  ?>
    ...
    <main id="main" class="main">
        <div class="row">
            ...
            <section class="section">
                ...
                <input hidden type="text" id="id_usuario" name="id_usuario" class="form-control">
                            ...
                            <div class="card-body waves-effect waves-light mt-2">
                                ...
                                <div class="hstack gap-2 left-content-end d-print-none mt-4">
                                    <button type="button" id="btn_Registrar_prestamo" class="botones"><i
                                            class=" ri-book-mark-line me-1"></i> Guardar
                                        Prestamo</button> 
                                </div>
                                <!---</form>-->
                            </div>
    ...
    ?>
    <script src="prestamosedit.js"></script>
